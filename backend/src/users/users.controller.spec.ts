...
describe('UsersController', () => {
  ...
  describe('update', () => {
    it('should update a user', async () => {
      ...
      expect(usersService.update).toHaveBeenCalledWith(1, updateUserDto as Partial<User>);
      expect(result).toEqual(mockUser);
    });
  });
  ...
  describe('updateOwnProfile', () => {
    it('should update only allowed fields', async () => {
      ...
      const result = await controller.updateOwnProfile(mockRequest as any, updateData);
